            ...
            <div className='log '>
                 <div style={{ height: "100vh" }} className="d-flex justify-content-center align-items-center">
                    <div className="row r1">
                        <div style={{ backgroundColor: "black", borderRadius: "30px" }} className="pp1 d-flex flex-column justify-content-center align-items-center col-lg-6 text-white px-2 py-3">
                            {insideRegister ?
                            ...
                            <p className='fs-5 text-danger fw-bolder'>{insideRegister ? "Register to Website" : "Login to explore more"}</p>
                            ...
                            }
                            {
                                insideRegister ?
                                    ...
                                    :
                                    <button onClick={handleLogin} className='btn btn-primary rounded mb-3'>Login Now</button>
                            }
                        ...
                        <div className="pp2 col-lg-6 d-flex justify-content-center align-items-center">
                            <img className='img-fluid' src="https://img.freepik.com/premium-vector/illustration-vector-graphic-cartoon-character-online-registration_516790-1807.jpg" alt="" />
                        </div>
                    </div>
                </div>
